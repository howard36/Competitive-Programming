...
<meta property="og:url" content="https://dmoj.ca/accounts/login/?next=/src/545195/raw">
<!--[if lt IE 9]>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/html5shiv/3.7.3/html5shiv.min.js"></script>
    <script>window.bad_browser = true</script>
    <![endif]-->
<link rel="stylesheet" href="//dmoj.algome.me/static/cache/css/5405fbc8cd00.css" type="text/css" /> <link rel="canonical" href="https://dmoj.ca/accounts/login/?next=/src/545195/raw">
<style>
        #login-panel {
            position: relative;
...
<input type='hidden' name='csrfmiddlewaretoken' value='0Xl3CSsEulEAmrAE6GcKQ4OYWV2l5tcjxpQCLVyovoRbzxwqucu1dbzu318B9wu6' /> <table border="0" style="text-align:left">
<tr>
...
<input type="hidden" name="next" value="/src/545195/raw">
</form>
<br><a href="/accounts/password/reset/">Forgot your password?</a>
<h4>Or log in with...</h4>
<a href="/login/google-oauth2/?next=/src/545195/raw" class="social google-icon">
<i class="fa fa-google-plus-square"></i>
</a>
<a href="/login/facebook/?next=/src/545195/raw" class="social facebook-icon">
<i class="fa fa-facebook-square"></i>
</a>
<a href="/login/github-secure/?next=/src/545195/raw" class="social github-icon">
<i class="fa fa-github-square"></i>
 </a>
<a href="/login/dropbox-oauth2/?next=/src/545195/raw" class="social dropbox-icon">
...
<input type='hidden' name='csrfmiddlewaretoken' value='0Xl3CSsEulEAmrAE6GcKQ4OYWV2l5tcjxpQCLVyovoRbzxwqucu1dbzu318B9wu6' /> <input name="next" type="hidden" value="/accounts/login/?next=/src/545195/raw">
